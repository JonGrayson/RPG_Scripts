...
public class EnemyBoss : MonoBehaviourPun
{
    [Header("Info")]
    ...
    void BossDeath()
    {
        //GameManager.instance.winningCinematic.SetActive(true);
        PlayerController.me.darkRepulsor.SetActive(true);
        endScene();
    }
    ...
    void endScene()
    {
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "EndScene");
    }
}